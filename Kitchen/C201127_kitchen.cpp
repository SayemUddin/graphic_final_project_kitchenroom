...
void Wall()
{
    ...
    glPopMatrix();
    //ceiling
    //glColor3f(0.0, 0.0, 0.545); // Dark Blue
    glColor3f(0.9, 0.9, 0.9); // RGB values for very pale gray
    glPushMatrix();
    //glScalef(5, 0.1, 7);
    ...
    // floor
    //glColor3f(0.9, 0.9, 0.9); // RGB values for very pale gray
    glColor3f(0.9, 0.9, 0.9); // RGB values for off-white
...
void Clock()
{
    ...
    glPushMatrix();
    glTranslatef(-0.9, 2.5, 7.87); // Increased the y-coordinate
    ...
    glPushMatrix();
    glTranslatef(-0.83, 2.6, 7.9); // Increased the y-coordinate
    ...
    glColor3f(0, 0, 0);
    glPushMatrix();
    glTranslatef(-0.65, 2.78, 8.01); // Increased the y-coordinate
    glRotatef(45, 1, 0, 0);
    ...
    glPushMatrix();
    glTranslatef(-0.66, 2.5, 7.89); // Increased the y-coordinate
    ...
    glColor3f(0.2, 0.1, 0.1);
    glPushMatrix();
    glTranslatef(-0.65, 2.5, 8.2); // Increased the y-coordinate
...
void Fridge() {
        glColor3f(0.5, 0.0, 0.5); // RGB values for purple
        glPushMatrix();
...
void Table(){
    ...
    //divider
    glColor3f(0.0, 0.0, 0.0); // RGB values for black
    glPushMatrix();
    ...
    //Microwave
    glColor3f(0.678, 0.847, 0.902); // Light Blue microwave side color
    glPushMatrix();
...
void window(){
    ...
    glScalef(.45, .7, -0.02);//size of inside the window
    drawCube();
    glPopMatrix();
    glColor3f(0, 0, 0);
    glPushMatrix();
    glTranslatef(2.1,1.9,1);
    glScalef(.5, .8, -0.01);//janalar border er size
    drawCube();
    glPopMatrix();
}
...
void Khawar_Table() {
    ...
    glColor3f(0.0, 0.0, 0.0);  // Brown color
    glPushMatrix();
...
int main (int argc, char **argv)
{
 ...
 glutCreateWindow("C201127_Sayem");
